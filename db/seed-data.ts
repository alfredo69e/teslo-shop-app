...
export const initialData: SeedData = {
    users: [
        { name: 'Alfredo Echeverria', password: bcrypt.hashSync( '123456' ), email: 'alfredo@google.com', role: 'admin' },
        { name: 'Josue Echeverria', password: bcrypt.hashSync( '123456' ), email: 'josue@google.com', role: 'client' },
    ],
    products: [
        {
